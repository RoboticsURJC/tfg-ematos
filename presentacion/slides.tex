...
\begin{table}[htbp]
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=0.3\textwidth, valign=m]{figs/roomba} & \includegraphics[width=0.3\textwidth, valign=m]{figs/rosa} \\
		\includegraphics[width=0.3\textwidth, valign=m]{figs/Robot-Medicina} & \includegraphics[width=0.3\textwidth, valign=m]{figs/log}
	\end{tabular}
...
\begin{frame}{}
  ...
  \note[item]{Busqué información sobre trabajos de acompañamiento y apoyo a personas mayores.}
...
\note[item]{no busca susituir la asistencia profesional.}
\note[item]{herramienta complementaria.}
...
\note[item]{Priorizar coste sin perder funcionalidad}
\note[item]{reproducible y asequible}
...
\note[item]{explicar voz y activación}
...
\note[item]{Ip fijas.}
\note[item]{funcionamiento por peticiones http.}
\note[item]{depende de la ip del pc.}
...
\begin{tabular}{cc}
		\includegraphics[width=0.3\textwidth, valign=m]{figs/logmal} & \includegraphics[width=0.3\textwidth, valign=m]{figs/idris} \\
		\includegraphics[width=0.3\textwidth, valign=m]{figs/juanes} & \includegraphics[width=0.3\textwidth, valign=m]{figs/sh}
\end{tabular}
