...
\begin{frame}{}
  \centering \Huge
  \emph{Plataforma software del sistema}
\note[item]{Pasemos ahora a comentar los objetivos que nos hemos con este trabajo.}
\end{frame}

\section{Plataforma software del sistema}
...
\includegraphics[height=5.5cm]{figs/sistema}
...
\hspace{0.02\textwidth}
\includegraphics[width=0.45\textwidth]{figs/sugerencia}
...
\begin{itemize}
\item Diseño y ensamblaje del robot.
\item Evaluación del reconocimiento facial.
\item Comparativa de modelos de lenguaje.
\item Validación del sistema completo.
\end{itemize}
\end{figure}
\end{frame}
...
\includegraphics[height=5cm]{figs/logmal}
...
\item \alert{Ampliar las funcionalidades} (seguimiento del usuario y reconocimiento de emociones).
\end{itemize}
\end{block}
\end{frame}
