...
\begin{enumerate}
	...
	\item textit{CB4}. Que los estudiantes puedan transmitir información, ideas, problemas y soluciones a un público tanto especializado como no especializado.
\end{enumerate}
...
Se han mantenido diversos frentes de trabajo abiertos de manera simultánea, permitiendo avanzar tanto en el área hardware y software. El desarrollo se ha llevado a cabo mediante ciclos de diseño, implementación y prueba, permitiendo comparar diferentes soluciones para un mismo problema y seleccionar la más optima.

\vspace{0.2cm}

Para la gestión del código y el control de versiones se ha utilizado la plataforma Github\footnote{https://github.com/}, gracias a lo cual se ha mantenido una estructura organizada del código. En la wiki se han plasmado los avances semana a semana detallando también los problemas que han ido surgiendo y las soluciones encontradas.

\vspace{0.2cm}

Además, se han realizado reuniones semanales con el tutor del TFG, tanto de forma presencial como mediante Microsoft Teams, para hacer seguimiento de los avances conseguidos y/o resolver dudas.
...
\begin{enumerate}
	...
	\item \textit{Investigación del hardware a utilizar:} Una vez encontrada una solución factible, se buscaron componentes \textit{hardware} \textit{low-cost}, compatibles con las soluciones identificadas.
	...
	\item \textit{Diseño del modelo del robot:} Tras definir el diseño del robot, se realizaron prototipos en cartón con el obejtivo de comprobar medidas y dimensiones. Una vez validado el diseño, se llevó a cabo el modelado 3D de las piezas mediante la herramienta FreeCAD.
	\item \textit{Impresión de las piezas 3D:} Una vez finalizado el diseño, se procedió a la impresión de las piezas.
	\item \textit{Implementación del software:}
	\item \textit{Sensores y actuadores:}
\end{enumerate}
