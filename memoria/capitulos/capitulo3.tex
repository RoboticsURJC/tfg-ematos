...
\begin{enumerate}
	...
	\item Integrar todos los componentes software en sistema funcional.
...
La gestión del código fuente y el control de versiones se ha realizado usando la plataforma Github\footnote{https://github.com/}, lo cual ha permitido mantener una estructura organizada del código.
El código del proyecto se encuentra alojado en un repositorio público\footnote{https://github.com/RoboticsURJC/tfg-ematos}, donde se han ido integrando de forma progresiva las distintas implementaciones, pruebas y mejoras realizadas a lo largo del desarrollo.
Asimismo, se ha utilizado la sección de wiki del repositorio para documentar tanto los avances alcanzados como los problemas encontrados y las soluciones adoptadas.
