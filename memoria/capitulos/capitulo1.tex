...
No obstante, no fue hasta 1921 donde se acuñó por primera vez el concepto de robot, en la obra de  teatro llamada  “R.U.R: ROBOTS UNIVERSALES ROSSUM”  del dramaturgo checo Karel Capek.
...
En muchos casos, estos robots no solo prestan apoyo funcional, sino que también buscan interactuar con las personas de manera más cercana, estableciendo una relación humano-robot. Este tipo de interacción dio lugar a una rama específica de la robótica denominada robótica social.
...
\begin{figure} [h!]
  \begin{center}
    \includegraphics[width=5cm]{figs/pepper}
  \end{center}
...
En las primeras etapas, la investigación en HRI se centró en los aspectos relacionados con la movilidad. Sin embargo, con el tiempo, se buscó que el robot tuviera comportamientos más natuarales y sociales, con el objetivo de mejorar la interacción entre el robot y la persona. \cite{hri2}s.
...
\begin{itemize}
	\item \texttt{Agricultura}. Permite evaluar la maduración de la fruta para la cosecha y detectar imperfecciones para su selección.
	\item \texttt{Seguridad}. Sistemas de vigilancia y control de tráfico utilizan algoritmos de visión artificial, por ejemplo para reconocer matrículas o monitorizar vehículos en carretera.
...
En esta época de cambios surge la Inteligencia Artificicial (IA) como disciplina, dedicada a dotar a la máquina de capacidades asociadas normalmente con los humanos como el razonamiento, aprendizaje o la capacidade de tomar decisiones.
...
\begin{itemize}
	...
	\item \texttt{Elección del modelo}. Existen multitud de modelos de aprendizaje automático, y su elección depende del objetivodel problema. Entre ellos se encuentran algoritmos de clasificación, predicción, regresión lineal, entre otros muchos.
...
Para abordar tareas más complejas y de mayor precisión, surge el \textit{Deep Learning}, una rama de la Inteligencia Artificial y del aprendizaje supervisado.

\section{Deeep Learning}
\label{sec:Deeep Learning}

El \textit{Deep Learning} o aprendizaje profundo, es un subcampo de la Inteligencia Artificial que se centra en el diseño y entrenamiento de redes neuronales con múltiples capas, inspiradas en el funcionamiento del cerebro humano.
...
La mayoría de equipos usan la arquitectura Von Neumann~\ref{fig:Von-Neumann}, una estructura basada en en una unidad de procesamiento y una memoria central que almacena tanto los datos como las instrucciones.
...
Por todo ello, surge la necesidad de buscar sistemas más económicos y sostenibles, capaces de realizar tareas similares pero con un menor impacto en el medio ambiente y la economía.
...
Como se ha comentado anteriormente, las limitaciones del hardware tradicional y alto cosumo energético asocido a los algoritmos de Inteligencia Artificial hace que surja la necesidad de soluciones más económicas y sostenibles, objetivo principal de la robótica de bajo coste.

\vspace{0.2cm}

Gracias a la robotica de bajo coste, este tipo de proyectos está al alcance de cualquiera, ya que resultan más asequibles para el público en general~\ref{fig:bajo-coste}.
...
La existencia de sistemas como la Raspberry Pi permite desarrollar sistemas capaces de realizar tareas complejas, aunque con ciertas limitaciones. Esto abre la puerta a multitud de aplicaciones en distintos ámbitos como la eduación o la investigación.

\vspace{0.5cm}

En este proyecto se presenta un sistema que mediante Visión Artificial, Machine Learning y Deep Learning es capaz de reconocer personas e interactuar con ellas de una forma relativamente fluida. Además, incorpora una serie de juegos interactivos con el propósito  de estimular cognitivamente a las personas mayores.


\vspace{0.5cm}

En los capítulos siguientes se presentarán los obetivos de este trabajo, las plataformas de desarrollo utilizadas para el desarrollo del proyecto, así como el diseño y la estructura del sistema. Por último, se expondrán las conclusiones obtenidas tras la investigación y la realización del proyecto.
