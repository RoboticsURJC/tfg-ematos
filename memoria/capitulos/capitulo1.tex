...
La robótica es un campo multidisciplinar que surge de la unión de la ciencia, la ingeniería y la tecnología. Se dedica al estudio, diseño, construcción e implementación de robots. Estos se pueden definir como una máquina programable capaz de realizar tareas de forma autónoma o semi-autónoma.

\vspace{0.5cm}

Los orígenes de la robótica se remontan a las antiguas civilizaciones del Antiguo Egipto, que ya desarrollaban modelos matemáticos muy avanzados y construyeron automatismos muy sofisticados, como el reloj de agua (Figura \ref{fig:origen} a).
Siglos más tarde, Leonardo da Vinci diseñó el \textit{Automa Cavaliere} (Figura \ref{fig:origen} b) , considerado uno de los primeros robots humanoides de la historia.
...
Por último, los robot sociales también se han hecho hueco en el ámbito del entretenimiento, donde se emplean como herramientas lúdicas e interactivas. Un ejemplo de ello es Sony Aibo (Figura \ref{fig:entretenimiento}), una mascota robótica diseñada por Sony\footnote{https://us.aibo.com/}.
...
Todas estas aplicaciones comparten un elemento en común: la necesidad de una interacción fluida y natural entre humano y robot. Para comprender, diseñar y evaluar estas interacciones, surgió un campo de estudio específico denominado Interacción Humano-Robot (HRI).
...
El objetivo es mejorar el rendimiento a lo largo del tiempo, aprendiendo qué acciones realizar en las diferentes situaciones para obtener una mayor recompensa.
...
El \textit{Deep Learning} o aprendizaje profundo, es un subcampo de la IA que se centra en el diseño y entrenamiento de redes neuronales artificiales con múltiples capas, inspiradas en el funcionamiento del cerebro humano. Esta redes permiten identificar de forma autónoma patrones complejos en grandes volúmenes de datos, lo que ha supuesto un avance significativo frente a métodos tradicionales.

\vspace{0.5cm}

Su uso más extendido se encuentra en aplicaciones de visión artificial, reconocimiento de voz y procesamiento de lenguaje natural.
