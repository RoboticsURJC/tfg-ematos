...
# CONFIGURACIÓN
# =====================
SERVER_IP = "192.168.1.96"   # <-- CAMBIA ESTO
SERVER_URL = f"http://{SERVER_IP}:5000/procesar"
...
def enviar_al_servidor(texto):
    try:
        r = requests.post(SERVER_URL, json={"texto": texto}, timeout=5)
