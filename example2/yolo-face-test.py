...
model = YOLO("../example2/runs/detect/train/weights/best.pt")  # Asegúrate de que este archivo existe
...
while cap.isOpened():
    ...
    for r in results:
        for box in r.boxes:
            ...
            # faces = detect_bounding_box(frame, conf)
